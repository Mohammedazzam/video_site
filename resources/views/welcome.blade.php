...
<div class="main">
    ...
    <div class="section section-navigation">
        ...
        <div id="navbar">
            <div class="navigation-example" style="background-image: url('/frontend/img/ilya-yakover.jpg');">
                <nav class="navbar navbar-expand-lg bg-primary">
                    <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-3">
                        ...
                        <img src="/frontend/img/uriel-soberanes.jpg" class="img-rounded img-responsive" alt="Rounded Image">
                    ...
                    <div class="col-sm-3 col-md-2 mr-auto ml-auto">
                        ...
                        <img src="/frontend/img/faces/kaci-baum-2.jpg" class="img-circle img-no-padding img-responsive" alt="Rounded Image">
                        <p class="text-center">Brigitte Bardot</p>
                    </div>
                    <div class="col-sm-3 col-md-2 mr-auto">
                        <h4 class="images-title">Thumbnail</h4>
                        <img src="/frontend/img/faces/erik-lucatero-2.jpg" class="img-thumbnail img-responsive" alt="Rounded Image">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid" src="/frontend/img/soroush-karimi.jpg" alt="First slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <p>Somewhere</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="/frontend/img/federico-beccari.jpg" alt="Second slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <p>Somewhere else</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid" src="/frontend/img/joshua-stannard.jpg" alt="Third slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <p>Here it is</p>
                                    </div>
                                </div>
    ...
    <div class="section section-image section-login" style="background-image: url('/frontend/img/login-image.jpg');">
        <div class="container">
            <div class="row">
            ...
            <div class="row example-page">
                <div class="col-md-6 text-center">
                    <a href="examples/landing.html" target="_blank">
                        <img src="/frontend/img/examples/landing-page.png" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
                        <a href="./examples/landing-page.html" class="btn btn-outline-neutral btn-round" target="_blank">Landing Page</a>
                    </a>
                </div>
                <div class="col-md-6 text-center">
                    <a href="examples/profile.html" target="_blank">
                        <img src="/frontend/img/examples/profile-page.png" alt="Rounded Image" class="img-rounded img-responsive" style="width: 100%">
